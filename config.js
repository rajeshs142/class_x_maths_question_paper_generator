...
const CHAPTERS = [
    ...
    { id: 3, name: "Pair of Linear Equations in Two Variables", file: "ch3_linear_equations.json" },
    ...
    { id: 9, name: "Some Applications of Trigonometry", file: "ch9_applications_of_trigonometry.json" },
...
const BOARD_BLUEPRINT = [
    ...
    { chapter: "Pair of Linear Equations in Two Variables", breakdown: { 1: 1, 2: 0, 3: 0, 4: 0, 5: 1 } },
    ...
    { chapter: "Some Applications of Trigonometry", breakdown: { 1: 0, 2: 0, 3: 0, 4: 0, 5: 1 } },
